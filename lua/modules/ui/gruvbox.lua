...
local overrides = {
    ...
    CursorLineNR = { fg = colors.green, bold = false },
    CursorLineNr = { fg = colors.green, bold = false },
    DiagnosticError = { fg = colors.dim_red, bg = colors.bg },
    DiagnosticSignError = { fg = colors.dim_red, bg = colors.bg },
    DiagnosticSignHint = { fg = colors.white, bg = colors.bg },
    DiagnosticSignInfo = { fg = colors.grey, bg = colors.bg },
    DiagnosticSignOk = { fg = colors.white, bg = colors.bg },
    DiagnosticSignWarn = { fg = colors.orange, bg = colors.bg },
    DiagnosticFloatingError = { fg = colors.dim_red, bg = colors.bg_light },
    DiagnosticFloatingHint = { fg = colors.white, bg = colors.bg_light },
    DiagnosticFloatingInfo = { fg = colors.grey, bg = colors.bg_light },
    DiagnosticFloatingOk = { fg = colors.white, bg = colors.bg_light },
    DiagnosticFloatingWarn = { fg = colors.orange, bg = colors.bg_light },
    DiagnosticUnderlineError = { fg = colors.dim_red, bg = colors.bg },
    DiagnosticUnderlineHint = { fg = colors.white, bg = colors.bg },
    DiagnosticUnderlineInfo = { fg = colors.grey, bg = colors.bg },
    DiagnosticUnderlineOk = { fg = colors.white, bg = colors.bg },
    DiagnosticUnderlineWarn = { fg = colors.orange, bg = colors.bg },
    DiagnosticVirtualTextError = { fg = colors.dim_red, bg = colors.bg },
    DiagnosticVirtualTextHint = { fg = colors.white, bg = colors.bg },
    DiagnosticVirtualTextInfo = { fg = colors.grey, bg = colors.bg },
    DiagnosticVirtualTextOk = { fg = colors.white, bg = colors.bg },
    DiagnosticVirtualTextWarn = { fg = colors.orange, bg = colors.bg },
    DiagnosticHint = { fg = colors.white, bg = colors.bg },
    DiagnosticInfo = { fg = colors.green, bg = colors.bg },
    DiagnosticOk = { fg = colors.white, bg = colors.bg },
    DiagnosticWarn = { fg = colors.orange, bg = colors.bg },
    ...
    ErrorMsg = { fg = colors.dim_red, bg = colors.bg, bold = false },
    FloatBorder = { fg = colors.green, bg = "NONE" },
    FloatTitle = { fg = colors.green, bg = "NONE" },
    ...
    CmpItemKindSnippet = { fg = colors.grey, bg = colors.bg },
    CmpItemKindVariable = { fg = colors.blue, bg = colors.bg },
    LazyNormal = { bg = colors.bg_light, fg = colors.white },
    LineNr = { fg = colors.line_nr, bg = colors.bg },
    MasonNormal = { bg = colors.bg_light, fg = colors.white },
    ...
    NormalFloat = { fg = colors.white, bg = colors.bg_light },
    ...
    TelescopeNormal = { bg = colors.bg, fg = colors.white },
    TelescopeSelectionCaret = { bg = colors.bg, fg = colors.white },
    TelescopeMultiSelection = { bg = colors.bg, fg = colors.white },
    TelescopeBorder = { bg = colors.bg, fg = colors.white },
    TelescopePromptPrefix = { bg = colors.bg, fg = colors.white },
    TelescopePrompt = { bg = colors.bg, fg = colors.white },
    ...
    Todo = { fg = colors.yellow, bg = colors.brightblue },
