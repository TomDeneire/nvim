...
" {{{ Setup
  ...
  let g:colors_name="Spunkshui"
" }}}
" {{{ Italics
  let g:spunkshui_next_terminal_italic = get(g:, 'spunkshui_next_terminal_italic', 0)
  let s:italic = ""
  if g:spunkshui_next_terminal_italic == 1
    let s:italic = "italic"
  endif
"}}}
" {{{ Bold
  let g:spunkshui_next_terminal_bold = get(g:, 'spunkshui_next_terminal_bold', 0)
  let s:bold = ""
  if g:spunkshui_next_terminal_bold == 1
   let s:bold = "bold"
  endif
"}}}
" {{{ Colors
