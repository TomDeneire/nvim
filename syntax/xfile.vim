" Vim syntax file
" Language:		Brocade x-file
" Maintainer:		Tom Deneire <tomdeneire@gmail.com>
" Last Change:		1 December 2022
...
syn region  xfileTagLine     oneline start="^screen" end=":" contains=xfileTag,operator
