...
syn region  mMacroArgs      oneline start="(" end=")" contained contains=mParams,mOperator,mString,mNumber,mPName,mUName,mFName,mGlobalName,mDoGoContained
syn region  mLine           oneline start=/^\s/ end=/$/ contains=mString,mOperator,mComment,mCommand,mNumber,mFunction,mMacro,mPName,mUName,mFName,mGlobalName,mDoGo,mMacroSingle
...
syn match   mOperator       "[+,\_\-*/=&#$!'\\\]\[<>?@\(/)«»:. ]" contained
...
syn match   mParams         contained /[$a-zA-Z0-9]*=["a-zA-Z0-9]*/ contains=mOperator,mParamLabel,mString,mNumber,mPName,mUName,mFName,mGlobalName
